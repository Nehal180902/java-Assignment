...
public class Main{
    ...
    private static final String PASSWORD = "Nehalt@180902"; // Your MySQL password
    ...
    private static void addStudent(Connection conn, Scanner sc) throws SQLException {
        String sql = "INSERT INTO students (id, name, marks,contNo) VALUES (?, ?, ?,?)";
        ...
        try (Statement stmt = conn.createStatement(); ResultSet rs = stmt.executeQuery(sql)) {
            ...
            while (rs.next()) {
                System.out.println(rs.getInt("id") + " | " +
                        rs.getString("name") + " | " +
                        rs.getInt("marks") + " | " + rs.getDouble("contNo"));
            }
        }
    }
